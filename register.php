        ...
        <div class="col-lg-4 col-md-5 col-sm-6 col-xs-7 mb-5">
          <div class="card rounded">
            <ul class="nav nav-tabs justify-content-center bg-light" style="padding: 20px">
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#donor">Donor</a>
              </li>
            </ul>
    ...
    <div class="tab-content">
       ...
       <div class="tab-pane container fade" id="donor">
         ...
         <form action="file/receiverReg.php" method="post" enctype="multipart/form-data">
          ...
          <input type="tel" name="dphone" placeholder="Donor Phone Number" class="form-control mb-3" required title="Enter password as you want">
          ...
          <input type="number" name="age" placeholder="Donor Age" class="form-control mb-3" required >
